...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Maxui v1`}</title>

        <meta
          name="description"
          content="Maxui v1: Elevating Your Freelance Experience. Discover a Marketplace Where Skills Meet Opportunities. Unleash Your Potential Today."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1664575196644-808978af9b1f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmcmVlbGFuY2VyfGVufDB8fHx8MTY5NTgzMjk2Nnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Maxui v1: Elevating Your Freelance Experience. Discover a Marketplace Where Skills Meet Opportunities. Unleash Your Potential Today.`}
            </Text>
            <Box
