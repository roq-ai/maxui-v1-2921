...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'New Application.create': { roles: ['owner', 'recruiter'], key: 'application', tenantPath: [], userPath: [] },
  'Shortlisted Freelancer.update': { roles: ['owner', 'recruiter'], key: 'shortlist', tenantPath: [], userPath: [] },
  'Approved Freelancer.update': { roles: ['owner', 'recruiter'], key: 'approval', tenantPath: [], userPath: [] },
};
